...
mod_main () {
	...
	${THE_SUB_XFCE4_TERMINAL_BIN_DIR_PATH}/package-install.sh
	...
	${THE_SUB_XFCE4_TERMINAL_BIN_DIR_PATH}/asset-install.sh
	...
	${THE_SUB_XFCE4_TERMINAL_BIN_DIR_PATH}/config-install.sh
