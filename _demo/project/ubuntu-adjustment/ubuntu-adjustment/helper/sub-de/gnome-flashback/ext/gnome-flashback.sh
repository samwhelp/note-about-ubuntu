...
mod_de_gnome_flashback_package_install () {

	util_error_echo
	util_error_echo '##'
	util_error_echo '## mod_de_gnome_flashback_package_install'
	util_error_echo '##'
	util_error_echo


	local package_list="$(mod_de_gnome_flashback_package_list_find_for_install)"
...
mod_de_gnome_flashback_package_list_find_for_install () {
...
mod_de_gnome_flashback_config_install () {

	util_error_echo
	util_error_echo '##'
	util_error_echo '## mod_de_gnome_flashback_config_install'
	util_error_echo '##'
	util_error_echo
...
mod_de_gnome_flashback_asset_install () {

	util_error_echo
	util_error_echo '##'
	util_error_echo '## mod_de_gnome_flashback_asset_install'
	util_error_echo '##'
	util_error_echo
