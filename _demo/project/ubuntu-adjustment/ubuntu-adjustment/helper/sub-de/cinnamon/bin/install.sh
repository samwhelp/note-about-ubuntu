...
source "${THE_SUB_DE_DIR_PATH}/cinnamon/ext/init.sh"
...
mod_main () {
	...
	${THE_SUB_DE_CINNAMON_BIN_DIR_PATH}/package-install.sh
	...
	${THE_SUB_DE_CINNAMON_BIN_DIR_PATH}/asset-install.sh
	...
	${THE_SUB_DE_CINNAMON_BIN_DIR_PATH}/config-install.sh
