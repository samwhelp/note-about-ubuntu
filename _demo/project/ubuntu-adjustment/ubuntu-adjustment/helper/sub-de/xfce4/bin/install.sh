...
source "${THE_SUB_DE_DIR_PATH}/xfce4/ext/init.sh"
...
mod_main () {
	...
	${THE_SUB_DE_XFCE4_BIN_DIR_PATH}/package-install.sh
	...
	${THE_SUB_DE_XFCE4_BIN_DIR_PATH}/asset-install.sh
	...
	${THE_SUB_DE_XFCE4_BIN_DIR_PATH}/config-install.sh
