...
mod_main () {
	...
	${THE_SUB_GNOME_SHELL_BIN_DIR_PATH}/package-install.sh
	...
	${THE_SUB_GNOME_SHELL_BIN_DIR_PATH}/asset-install.sh
	...
	${THE_SUB_GNOME_SHELL_BIN_DIR_PATH}/config-install.sh
