...
source "${THE_SUB_DIR_PATH}/plank/ext/init.sh"
...
mod_main () {
	...
	${THE_SUB_PLANK_BIN_DIR_PATH}/package-install.sh
	...
	${THE_SUB_PLANK_BIN_DIR_PATH}/asset-install.sh
	...
	${THE_SUB_PLANK_BIN_DIR_PATH}/config-install.sh
