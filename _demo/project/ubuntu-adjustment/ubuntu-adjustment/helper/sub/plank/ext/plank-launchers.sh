...
sys_plank_config_install_plank_launchers () {
	...
	echo
	echo "##"
	echo "## Config: sys_plank_config_install_plank_launchers"
	echo "##"
	echo
...
plank_config_install_dock1_launchers () {
	...
	echo "install -Dm644 ${THE_OVERLAY_DIR_PATH}/etc/skel/.config/plank/dock1/launchers/desktop.dockitem $HOME/.config/plank/dock1/launchers/desktop.dockitem"
	install -Dm644 "${THE_OVERLAY_DIR_PATH}/etc/skel/.config/plank/dock1/launchers/desktop.dockitem" "$HOME/.config/plank/dock1/launchers/desktop.dockitem"



	echo "install -Dm644 ${THE_OVERLAY_DIR_PATH}/etc/skel/.config/plank/dock1/launchers/pcmanfm-qt.dockitem $HOME/.config/plank/dock1/launchers/pcmanfm-qt.dockitem"
	install -Dm644 "${THE_OVERLAY_DIR_PATH}/etc/skel/.config/plank/dock1/launchers/pcmanfm-qt.dockitem" "$HOME/.config/plank/dock1/launchers/pcmanfm-qt.dockitem"


	echo "install -Dm644 ${THE_OVERLAY_DIR_PATH}/etc/skel/.config/plank/dock1/launchers/org.xfce.mousepad.dockitem $HOME/.config/plank/dock1/launchers/org.xfce.mousepad.dockitem"
	install -Dm644 "${THE_OVERLAY_DIR_PATH}/etc/skel/.config/plank/dock1/launchers/org.xfce.mousepad.dockitem" "$HOME/.config/plank/dock1/launchers/org.xfce.mousepad.dockitem"


	echo "install -Dm644 ${THE_OVERLAY_DIR_PATH}/etc/skel/.config/plank/dock1/launchers/firefox.dockitem $HOME/.config/plank/dock1/launchers/firefox.dockitem"
	install -Dm644 "${THE_OVERLAY_DIR_PATH}/etc/skel/.config/plank/dock1/launchers/firefox.dockitem" "$HOME/.config/plank/dock1/launchers/firefox.dockitem"


	echo "install -Dm644 ${THE_OVERLAY_DIR_PATH}/etc/skel/.config/plank/dock1/launchers/sakura.dockitem $HOME/.config/plank/dock1/launchers/sakura.dockitem"
	install -Dm644 "${THE_OVERLAY_DIR_PATH}/etc/skel/.config/plank/dock1/launchers/sakura.dockitem" "$HOME/.config/plank/dock1/launchers/sakura.dockitem"
