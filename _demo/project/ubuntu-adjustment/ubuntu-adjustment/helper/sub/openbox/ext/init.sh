...
THE_SUB_OPENBOX_PACKAGE_LIST_INSTALL_FILE_PATH="${THE_SUB_OPENBOX_BASE_DIR_PATH}/share/${THE_SUB_OPENBOX_BASE_DIR_NAME}/${THE_PACKAGE_LIST_INSTALL_FILE_NAME}"
THE_SUB_OPENBOX_PACKAGE_LIST_REMOVE_FILE_PATH="${THE_SUB_OPENBOX_BASE_DIR_PATH}/share/${THE_SUB_OPENBOX_BASE_DIR_NAME}/${THE_PACKAGE_LIST_REMOVE_FILE_NAME}"
