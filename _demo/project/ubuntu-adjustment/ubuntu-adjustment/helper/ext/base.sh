...
base_var_init () {
	...
	THE_SUB_DE_DIR_NAME="sub-de"
	THE_SUB_DE_DIR_PATH="$THE_HELPER_DIR_PATH/$THE_SUB_DE_DIR_NAME"

	THE_SUB_WM_DIR_NAME="sub-wm"
	THE_SUB_WM_DIR_PATH="$THE_HELPER_DIR_PATH/$THE_SUB_WM_DIR_NAME"
...
base_var_dump () {
	...
	util_debug_echo "THE_SUB_DE_DIR_NAME=$THE_SUB_DE_DIR_NAME"
	util_debug_echo "THE_SUB_DE_DIR_PATH=$THE_SUB_DE_DIR_PATH"

	util_debug_echo "THE_SUB_WM_DIR_NAME=$THE_SUB_WM_DIR_NAME"
	util_debug_echo "THE_SUB_WM_DIR_PATH=$THE_SUB_WM_DIR_PATH"
