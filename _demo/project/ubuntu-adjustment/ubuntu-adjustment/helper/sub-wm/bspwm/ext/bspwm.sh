...
mod_wm_bspwm_package_install () {

	util_error_echo
	util_error_echo '##'
	util_error_echo '## mod_wm_bspwm_package_install'
	util_error_echo '##'
	util_error_echo


	local package_list="$(mod_wm_bspwm_package_list_find_for_install)"
...
mod_wm_bspwm_package_list_find_for_install () {
...
mod_wm_bspwm_config_install () {

	util_error_echo
	util_error_echo '##'
	util_error_echo '## mod_wm_bspwm_config_install'
	util_error_echo '##'
	util_error_echo
...
mod_wm_bspwm_asset_install () {

	util_error_echo
	util_error_echo '##'
	util_error_echo '## mod_wm_bspwm_asset_install'
	util_error_echo '##'
	util_error_echo
