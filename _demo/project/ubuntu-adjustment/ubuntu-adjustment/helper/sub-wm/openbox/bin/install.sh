...
source "${THE_SUB_WM_DIR_PATH}/openbox/ext/init.sh"
...
mod_main () {
	...
	${THE_SUB_WM_OPENBOX_BIN_DIR_PATH}/package-install.sh
	...
	${THE_SUB_WM_OPENBOX_BIN_DIR_PATH}/asset-install.sh
	...
	${THE_SUB_WM_OPENBOX_BIN_DIR_PATH}/config-install.sh
