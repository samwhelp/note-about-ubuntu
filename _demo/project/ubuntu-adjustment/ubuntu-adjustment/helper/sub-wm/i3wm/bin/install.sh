...
source "${THE_SUB_WM_DIR_PATH}/i3wm/ext/init.sh"
...
mod_main () {
	...
	${THE_SUB_WM_I3WM_BIN_DIR_PATH}/package-install.sh
	...
	${THE_SUB_WM_I3WM_BIN_DIR_PATH}/asset-install.sh
	...
	${THE_SUB_WM_I3WM_BIN_DIR_PATH}/config-install.sh
