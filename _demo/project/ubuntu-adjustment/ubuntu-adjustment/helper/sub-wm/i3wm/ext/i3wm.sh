...
mod_wm_i3wm_package_install () {

	util_error_echo
	util_error_echo '##'
	util_error_echo '## mod_wm_i3wm_package_install'
	util_error_echo '##'
	util_error_echo


	local package_list="$(mod_wm_i3wm_package_list_find_for_install)"
...
mod_wm_i3wm_package_list_find_for_install () {
...
mod_wm_i3wm_config_install () {

	util_error_echo
	util_error_echo '##'
	util_error_echo '## mod_wm_i3wm_config_install'
	util_error_echo '##'
	util_error_echo
...
mod_wm_i3wm_asset_install () {

	util_error_echo
	util_error_echo '##'
	util_error_echo '## mod_wm_i3wm_asset_install'
	util_error_echo '##'
	util_error_echo
