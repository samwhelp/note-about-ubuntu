...
#util_style_attr_set_value "gtk-theme-name" "Numix" "settings.ini" "test"
util_style_attr_set_value "gtk-theme-name" "Numix" "settings.ini"
util_style_attr_set_value "gtk-icon-theme-name" "Numix" "settings.ini"
