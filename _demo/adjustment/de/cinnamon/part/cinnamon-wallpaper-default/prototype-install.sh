...
cinnamon_prototype_install () {
	...
	echo "sudo install -Dm644 ./config/cinnamon/schemas/50_cinnamon-wallpaper-main.gschema.override /usr/share/glib-2.0/schemas/50_cinnamon-wallpaper-main.gschema.override"
	sudo install -Dm644 "./config/cinnamon/schemas/50_cinnamon-wallpaper-main.gschema.override" "/usr/share/glib-2.0/schemas/50_cinnamon-wallpaper-main.gschema.override"
