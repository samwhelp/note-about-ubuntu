...
cinnamon_prototype_rollback () {
	...
	echo "sudo rm -rf /usr/share/glib-2.0/schemas/50_cinnamon-favorite-apps.gschema.override"
	sudo rm -rf "/usr/share/glib-2.0/schemas/50_cinnamon-favorite-apps.gschema.override"
