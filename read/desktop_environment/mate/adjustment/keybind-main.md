...
| 按鍵組合          | 功能     | 設定項目         |
| ----------------- | -------- | ---------------- |
| `Alt + 1`         | 切換到工作空間 1 (File) | `org.mate.Marco.global-keybindings switch-to-workspace-1` |
| `Alt + 2`         | 切換到工作空間 2 (Edit) | `org.mate.Marco.global-keybindings switch-to-workspace-2` |
| `Alt + 3`         | 切換到工作空間 3 (Web) | `org.mate.Marco.global-keybindings switch-to-workspace-3`
| `Alt + 4`         | 切換到工作空間 4 (Term) | `org.mate.Marco.global-keybindings switch-to-workspace-4` |
| `Alt + 5`         | 切換到工作空間 5 (Misc) | `org.mate.Marco.global-keybindings switch-to-workspace-5` |
