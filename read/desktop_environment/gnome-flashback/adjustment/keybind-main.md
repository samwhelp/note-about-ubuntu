...
| `Alt + Shift + 2`         | 移動視窗到工作空間 2 (Edit) | `org.gnome.desktop.wm.keybindings move-to-workspace-2` |
| `Alt + Shift + 3`         | 移動視窗到工作空間 3 (Web) | `org.gnome.desktop.wm.keybindings move-to-workspace-3`
| `Alt + Shift + 4`         | 移動視窗到工作空間 4 (Term) | `org.gnome.desktop.wm.keybindings move-to-workspace-4` |
| `Alt + Shift + 5`         | 移動視窗到工作空間 5 (Misc) | `org.gnome.desktop.wm.keybindings move-to-workspace-5` |
